      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          ...
          for(int i=0; i< sensor_fusion.size(); i++) {
            ...
            int check_car_lane;
            check_car_lane = int(double(sensor_fusion[i][6])/4.0);
            ...
            if ((check_car_s > car_s) && (check_car_s-car_s < 25)) {
              if (lane == check_car_lane){
                too_close = true;
                car_in_lane[check_car_lane] = 1;
              }
            }
            
            if((check_car_s-car_s > -5 ) && (check_car_s-car_s < 25)) {
              if (lane != check_car_lane)
                car_in_lane[check_car_lane] = 1;
            }
          }
          ...
          // ref x,y,yaw states
          // either will reference the starting points as where the car is or at the previous paths end points
          double ref_x = car_x;
          double ref_y = car_y;
